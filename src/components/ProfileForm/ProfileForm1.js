...
let {mssg} = this.state
    ...
    let Mssg = mssg ? (<Message positive floating><Message.Header>Information Saved</Message.Header>
      <p>Please click go back and find out your matching company</p></Message>) : (<Message floating><p>Your information is totally anonymous. We'll never use it in a way that might be used to identify you.</p> </Message>)
  return(
