const companyData = [
    {
        ...
        "website": "www.hpe.com",
        "benefitInfo": [
            "Flexible Hours", "Maternity Leave", "Mentorship Program", "Childcare", "PTO"
        ],
        "jobOpeningings": [
            {
                "jobTitle": "Software Engineer",
                "description": "Troubleshoots and debugs software and tools as part of a global, sustaining engineering team supporting the industry-leading Hewlett Packard Enterprise 3PAR storage solution."
            }, {
                "jobTitle": "Finance Associate Intern",
                "description": "At Hewlett Packard Enterprise, we don't just believe in the power of technology, we believe in the power of people when technology works for them. We believe in applying new thinking and ideas to improve the way our customers live and work."
            }, {
                "jobTitle": "Solution Architect",
                "description": "As a Senior Solution Architect, you have deep knowledge not just around databases but also the entire data pipeline. You have a clear understanding of lambda architectures. You understand the benefits of MPP batch processing technologies, in-memory technologies, and columnar databases."
            }
        ],
        "workLifeBalance": 4.5,
        ...
        "overall": 4.8,
        "reviews": [
            "People Focused Company that truly cares- excellent benefits, growth opportunities, and support.", "I really love working for HPE, benefits are amazing and I love the discounts we can get. My typical day is spent answering emails from trading partners about their accounts, why files rejected, and why they can't log in. ", "Strong peers who are driven and very focussed", "Great people working there but they have gotten away from care of their employees. Due to all the many changes of late it has caused much tension among the employees. Seems the company is more focused on their selves than their employees. Hard pressed for advancements or raises. Used to be a good company to work for but not so much now."
        ],
        "female_to_male_ratio": "45/55",
        "companyName": "goodcompany",
        "mentors": [
            {
                "name": "Meg Whitman",
                "title": "CEO",
                "image": "//media.licdn.com/media/AAEAAQAAAAAAAAULAAAAJDhkYWYwNTc0LTE0NGYtNDMzNy04NmU4LTQzMDA5MTIzMzA1OA.jpg"
            }, {
                "name": "Lisa-Marie Namphy",
                "title": "Developer Advocate",
                "image": "//media.licdn.com/mpr/mpr/shrinknp_400_400/p/2/000/0d1/2d1/3bfb723.jpg"
            }, {
                "name": "Claudia Braga",
                "title": "HPE Brazil Director",
                "image": "//media.licdn.com/mpr/mpr/shrinknp_400_400/p/1/005/098/004/080bb10.jpg"
            }
        ]
    }, {
        "_id": 1,
        "name": "Medium, LLC",
        "companyInfo": "We sell mediocre products at ok prices.",
        "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Medium_icon.svg/2000px-Medium_icon.svg.png",
        "website": "www.thewebsiteofthemediumcompaniedotcom.com",
        "benefitInfo": [
            "Overtime", "Unpaid vacation", "Parking"
        ],
        "jobOpeningings": [
            {
                "jobTitle": "Customer service rep",
                "description": "Must wear a wig"
            }
        ],
        "workLifeBalance": 3.5,
        "cultureAndValues": 3.1,
        "femaleLeadership": 3.8,
        "benefits": 2.8,
        "careerOpportunities": 3.0,
        "overall": 3.2,
        "reviews": ["All executives are men. It's a boys club where women have no opportunity to excel. They make it hard especially for working moms as long hours are mandatory.","Great hr benefits but if you work in the technical org and actually take them, they are actually not that supportive of families and pregnant women.","I had an amazing team but often women were looked down on their abilities, especially on the technical side. It is a great company to work for, just need to be in the right team."],
        "female_to_male_ratio": "35/65",
        "companyName": "averagecompany",
        "mentors": [
          {
                "name": "Kelly One",
                "title": "Developer",
                "image": "//preciouspeople.co.nz/wp-content/uploads/2015/02/user-icon-female-white-hi-large.png"
            }, {
                "name": "Kelly Two",
                "title": "Manager",
                "image": "//preciouspeople.co.nz/wp-content/uploads/2015/02/user-icon-female-white-hi-large.png"
